...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_SEARCH_URL = "url";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String KEY_SEARCH_RESPONSE = "response";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getCharSequence(KEY_SEARCH_URL));
            mSearchResultsTextView.setText(savedInstanceState.getCharSequence(KEY_SEARCH_RESPONSE));
        }
    }
