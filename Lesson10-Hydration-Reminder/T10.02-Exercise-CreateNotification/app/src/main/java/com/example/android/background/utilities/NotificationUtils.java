...
public class NotificationUtils {
    ...
    private static final int ID_CONTENT_INTENT = 1937;
    private static final int ID_NOTIFICATION = 8296;
    ...
    public static void remindUserBecauseCharging(final Context context) {
        ...
        final CharSequence contentText = context.getText(R.string.charging_reminder_notification_body);
    ...
    private static PendingIntent contentIntent(final Context context) {
    ...
    private static Bitmap largeIcon(final Context context) {
