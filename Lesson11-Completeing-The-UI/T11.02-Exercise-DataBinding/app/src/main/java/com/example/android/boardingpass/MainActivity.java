...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final BoardingPassInfo info = FakeDataUtils.generateFakeBoardingPassInfo();
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.textViewBoardingInCountdown.setText(String.format(Locale.ENGLISH,
                "00:%2d", info.getMinutesUntilBoarding()));
